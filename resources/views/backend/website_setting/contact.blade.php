            ...
            <form method="POST" class="btn-submit" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="form-group">
                    ...
                    <textarea id="summernoteabout" class="form-control" name="details">{{$Data->details}}</textarea>
                  </div>
                </div>  
              </div>
              ...
              <div class="form-group row">
                <div class="col-sm-9 mt-2">
                  <button type="submit" class="btn btn-info btn-sm" onclick="return confirm('Are You sure ?')" style=" border-radius: 0px;">Contact Update</button>
